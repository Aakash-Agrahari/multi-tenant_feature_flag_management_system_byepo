    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-900 via-brand-700 to-brand-500 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="font-display text-2xl font-bold text-white">Organization Admin</h1>
          <p className="mt-1 text-sm text-brand-100">Manage your organization's feature flags</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-brand-100">
          New organization?{' '}
          <Link to="/signup" className="font-semibold text-white underline underline-offset-2">
            Create one
          </Link>
        </p>
      </div>
