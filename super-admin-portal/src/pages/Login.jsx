    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-900 via-brand-800 to-brand-600 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="font-display text-2xl font-bold text-white">Super Admin Console</h1>
          <p className="mt-1 text-sm text-brand-100">Platform-wide control for the Feature Flag System</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-brand-200">
          Super Admin credentials are provisioned via environment configuration — there is no public signup.
        </p>
      </div>
    </div>
  );
